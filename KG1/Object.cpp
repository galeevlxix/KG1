...
void Floor::CreateBuffer() {
    ...
    Vertex Vertices[4] = { 
        Vertex(Vector3f(-10.0f, -1.0f, 10.0f), vec2(0.0f, 1.0f)),
        Vertex(Vector3f(10.0f, -1.0f, 10.0f), vec2(1.0f, 1.0f)),
        Vertex(Vector3f(-10.0f, -1.0f, -10.0f), vec2(0.0f, 0.0f)),
        Vertex(Vector3f(10.0f, -1.0f, -10.0f), vec2(1.0f, 0.0f)),
    };
